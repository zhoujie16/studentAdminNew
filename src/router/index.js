		...
		children: [
			{
				path: 'index',
				name: 'CampusManage',
				component: () => import('@/pages/CampusManage/index'),
		...
		children: [
			{
				path: 'index',
				name: 'GradeManage',
				component: () => import('@/pages/GradeManage/index'),
				meta: { title: '学届管理', icon: 'form' }
			}
		]
	},
		...
		children: [
			{
				path: 'index',
				name: 'ClassManage',
				component: () => import('@/pages/ClassManage/index'),
		...
		children: [
			{
				path: 'index',
				name: 'StudentManage',
				component: () => import('@/pages/StudentManage/index'),
				meta: { title: '校友管理', icon: 'form' }
			}
		]
	},
		...
		children: [
			{
				path: 'index',
				name: 'AuditManage',
				component: () => import('@/pages/AuditManage/index'),
				meta: { title: '审核事项', icon: 'form' }
			}
		]
	},
